...
export let alignmentMixin = flexLayoutAlignmentLiterals;
export let factorsMixin = flexLayoutFactorsLiterals;
export let positioningMixin = flexLayoutPositioningLiterals;
export let reversMixin = flexLayoutReverseLiterals;